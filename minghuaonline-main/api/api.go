...
func GetSchool() {
	...
	case 2:
		url = "https://www.xinpaikeji.com"
	case 3:
		url = "https://shixun.yuezhikeji.net"
	case 4:
		url = "https://shixun.kaidianshixun.com"
	case 5:
		fmt.Println("请输入网课实训地址,例如英华在线--http://mooc.yinghuaonline.com---")
		fmt.Scanf("%s\n", &url)
		fmt.Println()
	}
	url = url + "/api/login/school.json"
	client := &http.Client{}
